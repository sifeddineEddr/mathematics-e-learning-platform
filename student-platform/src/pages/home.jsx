  ...
  return (
    <div dir="rtl" className="w-full h-screen bg-brandSoftBrown p-8">
        ...
        <div className="gap-8 grid place-items-center sm:flex sm:items-center sm:justify-center sm:gap-28">
            ...
            <img src="/images/algebra-big-size.svg" alt="algebra" className="hidden cursor-pointer  sm:block w-1/6"/>
            <img src="/images/geometry-big-size.svg" alt="geometry" className="hidden cursor-pointer  sm:block w-1/6"/>
        </div>
        </div>
    </div>
  );
